...
public class EventController {
    ...
    @PostMapping("/events")
    public ResponseEntity<EventResponse> createEvents(@Valid @RequestBody EventCreateRequest request, Authentication authentication) {
    ...
    public ResponseEntity<EventResponse> updateEventsById(@PathVariable Long id, @Valid @RequestBody EventUpdateRequest request, Authentication authentication) {
